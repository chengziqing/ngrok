...
var _bintree = &_bintree_t{nil, map[string]*_bintree_t{
	"assets/server/tls/snakeoil.crt": &_bintree_t{assets_server_tls_snakeoil_crt, map[string]*_bintree_t{
	}},
	"assets/server/tls/snakeoil.key": &_bintree_t{assets_server_tls_snakeoil_key, map[string]*_bintree_t{
	}},
}}
